    ...
    try {
        ...
        if (Gravar()) {
            ...
            /*if ($ativo == 's') {
                ...
                $sql = sprintf("UPDATE login SET email = %s, senha = %s, ativo = %s", 
                ...
                if (!$result) {
                    ...
                    throw new Exception("Não foi possível Incluir o funcionário nas permissões de login !");
                }
            }*/
                        ...
                        <table cellspacing="10">
                            <tr>
                                ...
                                <td><input type="text" name="dt_demissao" placeholder="dd/mm/aa" size="16" 
                                           ...
                                           value="<?php echo $funcionario['dt_demissao'] == null ? null : $funcionario['dt_demissao']; ?>"</td>
                            </tr>
                            <tr>
